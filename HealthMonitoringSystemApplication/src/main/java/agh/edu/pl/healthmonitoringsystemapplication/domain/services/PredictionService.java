...
import agh.edu.pl.healthmonitoringsystemapplication.domain.components.ai_model.ModelPredictor;
import agh.edu.pl.healthmonitoringsystemapplication.domain.components.image.ImageDecoder;
import agh.edu.pl.healthmonitoringsystemapplication.domain.components.image.ImagePreprocessor;
import agh.edu.pl.healthmonitoringsystemapplication.domain.validators.PredictionRequestValidator;
