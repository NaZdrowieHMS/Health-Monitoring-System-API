...
@Getter
@Setter
public class AiPredictionComment {
    @Id
    ...
    public AiPredictionComment() {}

    @lombok.Builder(builderClassName = "Builder")
    public AiPredictionComment(Long id, Long doctorId, Long patientId, String content, LocalDateTime createdDate, LocalDateTime modifiedDate) {
            this.id = id;
    ...
    public static final class Builder {
        public AiPredictionComment build(){
            ...
            return new AiPredictionComment(id, doctorId, patientId, content, createdDate, modifiedDate);
        }
    }
}
