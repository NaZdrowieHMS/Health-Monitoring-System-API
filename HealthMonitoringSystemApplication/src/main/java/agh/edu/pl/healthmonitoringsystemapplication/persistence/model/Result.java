...
public class Result {
    ...
    public Result(Long id, Long patientId, String testType, String content, Boolean aiSelected, Boolean viewed,
    ...
    public static final class Builder {
        public Result build(){
            ...
            return new Result(id, patientId, testType, content, aiSelected, viewed, createdDate, modifiedDate);
        }
    }
}
