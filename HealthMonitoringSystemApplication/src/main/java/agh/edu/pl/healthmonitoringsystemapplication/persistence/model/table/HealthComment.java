...
public class HealthComment {
    ...
    public HealthComment(Long id, Long doctorId, Long patientId, String content, LocalDateTime createdDate, LocalDateTime modifiedDate) {
        this.id = id;
    ...
    public static final class Builder {
        public HealthComment build(){
            ...
            return new HealthComment(id, doctorId, patientId, content, createdDate, modifiedDate);
        }
    }
}
