...
import agh.edu.pl.healthmonitoringsystem.domain.components.ai_model.ModelPredictor;
import agh.edu.pl.healthmonitoringsystem.domain.components.image.ImageDecoder;
import agh.edu.pl.healthmonitoringsystem.domain.components.image.ImagePreprocessor;
import agh.edu.pl.healthmonitoringsystem.domain.validators.PredictionRequestValidator;
