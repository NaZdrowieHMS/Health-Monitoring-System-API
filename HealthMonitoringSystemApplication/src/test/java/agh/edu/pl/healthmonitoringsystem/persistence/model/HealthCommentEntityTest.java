...
public class HealthCommentEntityTest {
    ...
    public void shouldInitializeFieldsCorrectlyUsingBuilder() {
        ...
        // When
        HealthCommentEntity health = ModelEntityTestUtil.healthBuilder()
                .id(id)
                .doctorId(doctorId)
                .patientId(patientId)
                .content(content)
    ...
    public void shouldInitializeFieldsCorrectlyUsingConstructor() {
        ...
        // When
        HealthCommentEntity health = new HealthCommentEntity(id, doctorId, patientId, content, createdDate, modifiedDate);
    ...
    public void shouldCreateHealthWithDefaultConstructor() {
        // When
        HealthCommentEntity health = new HealthCommentEntity();
    ...
    public void shouldThrowExceptionWhenDoctorIdIsNull() {
        ...
        Exception exception = assertThrows(RequestValidationException.class, () ->
                ModelEntityTestUtil.healthBuilder()
                        .doctorId(null)
                        .patientId(1L)
